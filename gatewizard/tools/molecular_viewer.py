...
class MolecularViewer:
                ...
                if line.startswith("ATOM") or line.startswith("HETATM"):
                    try:
                        ...
                        if (
                            ...
                            or current_residue["id"] != res_id
                            or current_residue["chain"] != chain_id
                        ):

                            if current_residue is not None:
                                residues.append(current_residue)
                                chains[current_residue["chain"]]["residues"].append(
                                    current_residue
                                )
    ...
    def change_representation(
        self, representation: str, selection: str = "all"
    ) -> bool:
