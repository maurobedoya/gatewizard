...
class StageProgressIndicator(ctk.CTkFrame):
    ...
    def _create_widgets(self):
        ...
        for i, stage in enumerate(self.stages):
            ...
            # Stage label
            label = ctk.CTkLabel(self.progress_frame, text=stage, font=FONTS["small"])
    ...
    def _update_indicators(self):
        ...
        for i, stage in enumerate(self.stages):
            ...
            if stage in self.completed_stages:
                ...
                indicator.configure(fg_color=COLOR_SCHEME["active"], text="✓")
            elif i == self.current_stage_index:
                # Current stage - blue
                indicator.configure(fg_color=COLOR_SCHEME["highlight"], text=str(i + 1))
            else:
                # Future stage - gray
                indicator.configure(fg_color=COLOR_SCHEME["inactive"], text=str(i + 1))
